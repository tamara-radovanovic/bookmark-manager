...
const VARIANT_CLASSES: Record<ButtonVariant, string> = {
  ...
  secondary:
    "rounded-2xl border border-blush-300 bg-white px-7 py-4.75 text-ink-400 hover:bg-blush-100 hover:text-blush-600",
  // Small inline pill action (Navbar links, card "Edit").
  pill: "rounded-full border border-blush-300 bg-white px-5.5 py-3.25 text-ink-400 hover:bg-blush-100 hover:text-blush-600",
  ...
  "pill-danger":
    "rounded-full border border-danger-border bg-white px-5 py-3 text-danger-text hover:bg-danger-bg hover:text-danger-text-hover",
};

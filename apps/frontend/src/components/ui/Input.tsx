...
const FIELD_CLASSES =
  "rounded-2xl border-[1.5px] bg-[#fffdfe] px-5 py-4.5 font-body text-lg text-ink-700 outline-none placeholder:text-ink-200 focus:border-blush-400 focus:shadow-[0_0_0_4px_rgba(233,140,174,0.18)]";
